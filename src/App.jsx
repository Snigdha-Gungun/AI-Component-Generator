    ...
    <>
      ...
      <div className="flex items-center px-[100px] justify-between gap-[30px]">
        <div className="left w-[50%] h-[auto] py-[30px] rounded-xl bg-[#141319] mt-5 p-[20px]">
          ...
          <textarea onChange={(e) => { setPrompt(e.target.value) }} value={prompt} className='w-full min-h-[200px] rounded-xl bg-[#090908] mt-3 p-[10px]' placeholder="Describe your component in detail and let AI do the magic!"></textarea>
        ...
        <div className="right relative mt-2 left w-[50%] h-[80vh] bg-[#141319] rounded-xl">
          {
            outputScreen === false ?
              <>
                ...
                <div className="top2 bg-[#17171C] w-full h-[60px] flex items-center justify-between gap-[15px] px-[20px]">
                  <div className="left">
                  ...
                  <div className="right flex items-center gap-[10px]">
                    {
                      tab === 1 ?
                        <>
                          <button className="copy w-[40px] rounded-xl border-[1px] border-zinc-800 flex items-center justify-center transition-all hover:bg-[#333]" onClick={copyCode}><IoCopy /></button>
                          <button className="export w-[40px] rounded-xl border-[1px] border-zinc-800 flex items-center justify-center transition-all hover:bg-[#333]" onClick={downloadFile}><PiExport /></button>
                        </>
                        :
                        <>
                          <button className="copy w-[40px] rounded-xl border-[1px] border-zinc-800 flex items-center justify-center transition-all hover:bg-[#333]" onClick={() => { setIsNewTabOpen(true) }}><ImNewTab /></button>
                          <button className="export w-[40px] rounded-xl border-[1px] border-zinc-800 flex items-center justify-center transition-all hover:bg-[#333]"><FiRefreshCcw /></button>
                        </>
                    }
                  </div>
                </div>
      ...
      </div>
      {
        isNewTabOpen === true ?
          <>
            <div className="container absolute top-0 left-0 right-0 bottom-0 bg-white w-screen min-h-screen overflow-auto">
              <div className="top text-black w-full h-[60px] flex items-center justify-between px-[20px]">
                <div className="left">
                  <p className='font-bold'>Preview</p>
                </div>
                <div className="right flex items-center gap-[10ox]">
